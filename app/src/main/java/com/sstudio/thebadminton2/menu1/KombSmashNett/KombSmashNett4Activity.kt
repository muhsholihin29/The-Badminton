...
class KombSmashNett4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar_kombsmashnett4.title = getString(R.string.title_Smash_Forehand_dan_Netting_Backhand_Berpasanagan)
        ...
        video_view_kombsmashnett4.setVideoPath(BuildConfig.BASE_URL +getString(R.string.vid_Smash_Forehand_dan_Netting_Backhand_Berpasanagan)).player.start()
    }
