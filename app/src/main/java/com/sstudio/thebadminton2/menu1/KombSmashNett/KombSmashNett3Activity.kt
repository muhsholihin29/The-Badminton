...
class KombSmashNett3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar_kombsmashnett3.title = getString(R.string.title_Smash_Forehand_dan_Netting_Forehand_Berpasanagan)
        ...
        video_view_kombsmashnett3.setVideoPath(BuildConfig.BASE_URL +getString(R.string.vid_Smash_Forehand_dan_Netting_Forehand_Berpasanagan)).player.start()
    }
